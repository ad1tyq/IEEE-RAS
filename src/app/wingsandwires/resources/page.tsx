...
import { droneResources } from 'data/wingsandwires/resourcesData';
      ...
      <main className="pt-48 pb-32">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center mb-24">
            <h1 className="font-pixel text-4xl md:text-6xl mb-6 neon-glow">RESOURCES</h1>
          ...
          >
            <div className="space-y-6">
              ...
              {(droneResources as ResourceCategory[]).map((domain, domainIndex) => {
                          ...
                          <div key={item.id} className="block h-full">
                            ...
                            >
                              ...
                              <div className='flex justify-end items-center'>
                                ...
                                key={item.id} className="block h-full cursor-pointer text-purple-500 font-semibold hover:scale-105 py-4 duration-300">
                                  More Info -&gt;</Link>
                              </div>

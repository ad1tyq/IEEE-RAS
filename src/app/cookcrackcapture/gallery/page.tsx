  ...
  return (
    <div className="bg-black/60 text-white min-h-screen">
      ...
      <main className={styles.container}>
        <div className="absolute top-48 left-6 z-50 hidden md:block">
          <Link href="/cookcrackcapture" className="inline-flex items-center space-x-2 text-gray-400 hover:text-green-500 transition-colors font-mono-pixel bg-black/60 px-4 py-2 rounded-lg border border-green-500/30">
            <ArrowLeft size={18} />
            <span>Back</span>
          </Link>
        </div>

        <div className="relative mt-40 mb-12 z-50 text-center w-full px-4">

                ...
                >
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        {[...Array(3)].map((_, i) => (
                            <motion.div
                                key={`vscanline-${i}`}
                                className="absolute h-full w-0.5 bg-gradient-to-b from-transparent via-blue-400 to-transparent opacity-60"
                                style={{ left: `${25 + i * 25}%` }}
                                animate={{
                                    opacity: [0, 0.8, 0],
                                    scaleY: [0, 1, 0]
                    ...
                    >
                        ...
                        >
                            Loading development experience...
                        </motion.div>
                    </motion.div>

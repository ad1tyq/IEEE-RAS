                ...
                `,
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        {[...Array(5)].map((_, i) => (
                            <motion.div
                                key={`scanline-${i}`}
                                className="absolute w-full h-0.5 bg-gradient-to-r from-transparent via-green-500 to-transparent opacity-80"
                                style={{
                                    top: `${15 + i * 20}%`,
                                }}
                                animate={{
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                        {[...Array(3)].map((_, i) => (
                            <motion.div
                                key={`vscanline-${i}`}
                                className="absolute h-full w-0.5 bg-gradient-to-b from-transparent via-yellow-500 to-transparent opacity-60"
                                style={{
                                    left: `${25 + i * 25}%`,
                                }}
                                animate={{
                    ...
                    <div className="absolute inset-8 border-2 border-green-500/40 pointer-events-none">
                        ...
                        {[
                            ...
                            <motion.div
                                key={corner.corner}
                                className={`absolute w-12 h-12 border-green-500 ${corner.classes}`}
                    ...
                    <div className="relative z-10 text-center mb-8">
                        ...
                        <motion.div
                            ...
                            style={{
                                ...
                                background: 'linear-gradient(45deg, transparent 48%, rgba(234, 179, 8, 0.1) 49%, rgba(34, 197, 94, 0.1) 51%, transparent 52%)',
                    ...
                    <div
                        ...
                        style={{
                            background: 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(34, 197, 94, 0.15) 2px, rgba(34, 197, 94, 0.15) 4px)'
                        }}
                    />
